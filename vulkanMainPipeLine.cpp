...
void app::mainLoop() {
	while (!glfwWindowShouldClose(window)) {
		glfwPollEvents();
		drawFrame(device, graphicsQueue, presentQueue, swapChain, imageAvailableSemaphores, renderFinishedSemaphores, commandBuffers, currentFrame, inFlightFences, imagesInFlight);
	}
...
void app::initVulkan() {
	...
	createCommandBuffers(commandBuffers, swapChainFramebuffers, commandPool, device, renderPass, swapChainExtent, graphicsPipeline);
